...
public final class BaristaConstants {
    ...
    public static final String EGG_OUT = "\n***********************\n" +
                                         "Barista-matic 5000\n" + 
                                         "Version 1.0\n" + 
    ...
    public static final String EGG      = "e";
    
    public static final String[] KEYWORDS = { QUIT, RESTOCK, EGG };
    ...
    public static final Integer INDEX_OF_PRICE          = 0;
    public static final Integer INDEX_OF_AVAILABLITY    = 1;
